					...
					<div class="cart">					
						...
						<div class="beta-dropdown cart-body">				
							...
							<div class="cart-item" id="cart-item{{$products['item']['id']}}">			
								<a class="cart-item-delete" href="del-cart/{{$products['item']['id']}}" value="{{$products['item']['id']}}" soluong="{{$products['qty']}}"><i class="fa fa-times"></i></a>		
								<div class="media">		
									...
									<div class="media-body">	
										...
										<span class="cart-item-amount">{{$products['item']['qty']}}*<span>{{$products['item']['unit_price']}}</span></span>
									</div>	
								</div>		
							</div>			
							@endforeach			
